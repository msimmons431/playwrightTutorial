...
class LoginPageObjModel():
    ...
    def login_and_return_page(self) -> playwright:
        ...
        self.page.get_by_test_id("signUp.switchToSignUp").click(timeout=10000)
...
class KubePage():
    def __init__(self,kubepage):
        self.kubepage = kubepage

    def return_kube_page(self) -> playwright:
        return self.kubepage
